...
<template>
    <JetActionSection>
        ...
        <template #content>
            ...
            <div class="mt-3 max-w-xl text-sm text-gray-600 dark:text-neutral-400">
                <p>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-neutral-400">
                    ...
                    <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-neutral-400" v-if="setupKey">
