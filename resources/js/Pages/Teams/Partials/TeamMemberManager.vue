            ...
            <JetFormSection @submitted="addTeamMember">
                ...
                <template #form>
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600 dark:text-neutral-400">
                    ...
                    <div v-if="availableRoles.length > 0" class="col-span-6 lg:col-span-4">
                        ...
                        <div class="relative z-0 mt-1 border border-gray-200 dark:border-neutral-700 rounded-lg cursor-pointer">
                            <button
                                ...
                                :class="{'border-t border-gray-200 dark:border-neutral-700 rounded-t-none': i > 0, 'rounded-b-none': i != Object.keys(availableRoles).length - 1}"
                                @click="addTeamMemberForm.role = role.key"
                            >
                                <div :class="{'opacity-50': addTeamMemberForm.role && addTeamMemberForm.role != role.key}">
                                    <!-- Role Name -->
                                    <div class="flex items-center">
                                        <div class="text-sm text-gray-600 dark:text-neutral-400" :class="{'font-semibold': addTeamMemberForm.role == role.key}">
                                            {{ role.name }}
                                        </div>
                                    ...
                                    <!-- Role Description -->
                                    <div class="mt-2 text-xs text-gray-600 dark:text-neutral-400 text-left">
                                        {{ role.description }}
                                    </div>
                                </div>
                            </button>
                    ...
                    <div class="relative z-0 mt-1 border border-gray-200 dark:border-neutral-700 rounded-lg cursor-pointer">
                        ...
                        >
                            <div :class="{'opacity-50': updateRoleForm.role && updateRoleForm.role !== role.key}">
                                <!-- Role Name -->
                                <div class="flex items-center">
                                    <div class="text-sm text-gray-600 dark:text-neutral-400" :class="{'font-semibold': updateRoleForm.role === role.key}">
                                        {{ role.name }}
                                    </div>
                                ...
                                <!-- Role Description -->
                                <div class="mt-2 text-xs text-gray-600 dark:text-neutral-400">
                                    {{ role.description }}
                                </div>
                            </div>
                        </button>
