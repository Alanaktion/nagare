...
<template>
    <div>
        <div class="p-6 sm:px-20 bg-white dark:bg-neutral-800 border-b border-gray-200 dark:border-neutral-700">
            <div>
        ...
        <div class="bg-gray-50 dark:bg-neutral-850 grid grid-cols-1 md:grid-cols-2">
            <div class="p-6">
                <div class="flex items-center">
                    <svg
                        ...
                        stroke-width="2"
                        viewBox="0 0 24 24"
                        class="w-8 h-8 text-gray-400 dark:text-neutral-600"
                    ...
                    <div class="ml-4 text-lg text-gray-600 dark:text-neutral-300 leading-7 font-semibold">
                ...
                <div class="ml-12">
                    ...
                    <a href="https://laravel.com/docs">
                        <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700 dark:text-indigo-400">
            ...
            <div class="p-6 border-t border-gray-200 dark:border-neutral-700 md:border-t-0 md:border-l">
                <div class="flex items-center">
                    <svg
                        fill="none"
                        stroke="currentColor"
            ...
            <div class="p-6 border-t border-gray-200 dark:border-neutral-700 md:border-l">
                <div class="flex items-center">
                    <svg
                        fill="none"
                        stroke="currentColor"
